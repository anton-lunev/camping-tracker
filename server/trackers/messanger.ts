...
const apiToken = process.env.NEXT_PUBLIC_TELEGRAM_API_TOKEN!;
const chatId = process.env.NEXT_PUBLIC_TELEGRAM_CHAT_ID!;

if (!apiToken || !chatId) {
  throw new Error(
    "Environment variables NEXT_PUBLIC_TELEGRAM_API_TOKEN and NEXT_PUBLIC_TELEGRAM_CHAT_ID must be set.",
  );
}
